...
var middleware = function(options) {
  ...
  var add = function(specificMiddleware) {
    matchesUrl = getMatcher(specificMiddleware.matcher);
    getFileName = getFileNameFromMatcher(specificMiddleware.matcher);
    contentDir = specificMiddleware.contentDir;
    isExcluded = getIsExcluded(specificMiddleware.excludes);
    return middlewareFn;
  };
